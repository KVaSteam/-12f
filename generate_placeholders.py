...
def generate_default_placeholders():
    ...
    profile_pic_path = os.path.join(dirs[0], 'default.jpg')
    event_logo_path = os.path.join(dirs[1], 'default_event.jpg')
    news_image_path = os.path.join(dirs[2], 'default_news.jpg')
    achievement_path = os.path.join(dirs[3], 'default_achievement.png')
    ...
    generate_achievement_placeholder(
        os.path.join(dirs[3], 'achievement_organizer.png'), 
        achievement_type='organizer'
    )
    generate_achievement_placeholder(
        os.path.join(dirs[3], 'achievement_participation.png'), 
        achievement_type='participation'
    )
    generate_achievement_placeholder(
        os.path.join(dirs[3], 'achievement_special.png'), 
